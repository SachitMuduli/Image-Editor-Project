...
public class ImageEditorPanel extends JPanel implements KeyListener {
    ...
    public ImageEditorPanel() {
        ...
        try {
            imageIn = ImageIO.read(new File("sachitmuduli.jpg"));
        } catch (IOException e) {
    ...
    public static Color[][] rainbowFilter(Color[][] origJPG) { // will come back to fix this horrendous filter later possibly after feedback
